...
const { db, db2, messaging, storage, auth } = require("./firebase-modules");
...
db.collection("users").onSnapshot(snap => updateUserRoom(snap));
db.collection("users").onSnapshot(snap => deleteUser(snap));*/
