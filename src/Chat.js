...
function Chat({ animState, unreadMessages, b, audioList, messageSentAudio, messageReceivedAudio,roomOnline }) {
            ...
            <div style={!roomID ? { display: "none" } : {}} ref={chatAnim} className="chat">
                ...
                <div className="chat__header">
                    ...
                    <div className="chat__header--right">
                        ...
                        <IconButton aria-controls="menu" aria-haspopup="true" onClick={state.userID ? event => setOpenMenu(event.currentTarget) : null}>
                            <MoreVert sx={{
                                color: state.userID ? "auto" : "#A9A9A9"
                            }} />
                        </IconButton>
                        <Menu
                            anchorEl={openMenu}
